<?php
    ...
    if(!(isset($_SESSION['id']))){
        ...
        $book = mysqli_query($conn, "SELECT * from booking where C_ID='$id' AND Status='Unpaid'");
        ...
        <form action="deletebook.php" method="POST">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="bookid[]" value="<?php echo $row["B_ID"];?>">
                        </td>
                    </tr>
                <?php
                        }
                ...
                <br>
                <p align="center"><button type="submit" class="btn btn-primary" style="background-color:blue; border-color:black; color:white">Proceed</button></p>
                <br>
            </form>
        </div>
</div>  
